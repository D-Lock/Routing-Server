...
if not registry:
    ...
    print("export DOCKER_REGISTRY=redbackthomson # use the Docker Hub")
...
# Modify the project name to fit the docker syntax
...
for service_name, service in compose_file.services.items():
    if "build" in service:
        # Must be lowercase for tag names
        service_name = service_name.lower()
        compose_image = "{}_{}".format(project_name, service_name)
        registry_image = "{}/{}:{}".format(registry, service_name, version)
